<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Search and add items to cart') }}
        </h2>
    </x-slot>
    ...
    <div class="overflow-x-auto">
        ...
        <div class=" flex items-center justify-center bg-gray-100 font-sans overflow-hidden">
            <div class="w-full lg:w-5/6">
                <div id="app" class="rounded my-6">
                    <div class="relative w-full px-1 max-w-full flex-grow flex-1">
                        <span v-show="loading">Loading...</span>
                        <div class="relative mb-10">
                            <div class="flex">
                                <div class=" flex-grow">
                                    <input type="text" name="" id="" v-model="search_query"
                                        class="p-3 text-xs leading-none rounded-l w-full appearance-none">
                                </div>
                                <button
                            ...
                            <div>
                                <span v-for="product in results" @click="addToCart(product)"
                    ...
                    <table class="min-w-max w-full table-auto">
                        ...
                        <tbody id="" class="text-gray-600 text-sm font-light">
